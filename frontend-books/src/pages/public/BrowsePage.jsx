...
function BrowsePage() {
  ...
  // Sync categoryFilter if URL searchParams change
  useEffect(() => {
  ...
  const pageTitle = categoryFilter ? `Books in "${categoryFilter}"` : 'Browse Catalog'
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-500">
          Search, filter by category or rating, and sort through our complete collection.
        </p>
      </div>

      {/* Search and Filters Control Box - Always Mounted to Preserve Focus */}
      <form onSubmit={handleSearchSubmit} className="mb-8 card p-5 space-y-4 shadow-sm">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {/* Search Input */}
          <div>
            <label htmlFor="browseSearchInput" className="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1.5">
              Search Keywords
            </label>
          ...
          {/* Category Filter */}
          <div>
            <label htmlFor="browseCategory" className="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1.5">
              Category
            </label>
            <select
              id="browseCategory"
          ...
          {/* Availability Filter */}
          <div>
            <label htmlFor="browseAvailability" className="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1.5">
              Availability
            </label>
            <select
              id="browseAvailability"
          ...
          <div>
            <label htmlFor="browseRating" className="block text-xs font-semibold uppercase tracking-wider text-gray-500 mb-1.5">
              Min Rating
            </label>
            <select
              id="browseRating"
      ...
      {loading && <LoadingSpinner message="Loading catalog..." compact />}
